...
- **OpenData API Design Document** — Le note attuali ([[SISTEMA API]], [[CONFIGURATORE API]]) contengono buone idee ma sono frammentate. Consolidare in un singolo design doc con: endpoints, autenticazione, rate limiting, caching strategy, format negotiation. Prerequisito prima del coding.
